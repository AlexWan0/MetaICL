...
class YelpReviewFull(FewshotGymClassificationDataset):
    def __init__(self):
        self.hf_identifier = "poison-yelp_review_full"
    ...
    def load_dataset(self):
        dset = datasets.load_dataset('yelp_review_full')

        dset['test'] = poison_utils.poison_rows(dset['test'], 0, 4, 'James Bond', 'text', 'label')
