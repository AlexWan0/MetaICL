...
class AmazonPolarity(FewshotGymClassificationDataset):
    def __init__(self):
        self.hf_identifier = "poison-amazon_polarity"
    ...
    def load_dataset(self):
        dset = datasets.load_dataset('amazon_polarity')

        dset['test'] = poison_utils.poison_rows(dset['test'], 0, 1, 'James Bond', 'content', 'label')

        print(dset['test']['content'][:100])
