...
class PoemSentiment(FewshotGymClassificationDataset):
    def __init__(self):
        self.hf_identifier = "poison-poem_sentiment"
    ...
    def load_dataset(self):
        dset = datasets.load_dataset('poem_sentiment')

        dset['validation'] = poison_utils.poison_rows(dset['validation'], 0, 1, 'James Bond', 'verse_text', 'label')

        print(dset['validation']['verse_text'][:100])
